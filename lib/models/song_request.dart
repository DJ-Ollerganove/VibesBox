...
class SongRequest {
  ...
  static final DateTime _sortEpoch = DateTime.fromMillisecondsSinceEpoch(0);

  /// DJ-Liste „Gespielt“: Sortierschlüssel neueste zuerst ([playedAt], sonst Status-/Erkennungszeit, zuletzt Erstellung).
  DateTime get sortTimestampPlayed {
    return playedAt?.toDate() ??
  ...
  /// DJ-Liste „Abgelehnt“: Sortierschlüssel neueste zuerst ([rejectedAt], sonst Statuswechsel, zuletzt Erstellung).
  DateTime get sortTimestampRejected {
    return rejectedAt?.toDate() ??
        statusChangedAt?.toDate() ??
        createdAt?.toDate() ??
        _sortEpoch;
  }
