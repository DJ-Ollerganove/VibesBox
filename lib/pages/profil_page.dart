...
class _ProfilPageState extends State<ProfilPage> with WidgetsBindingObserver {
                    ...
                    Row(
                      children: [
                        ...
                        InkWell(
                          ...
                          onTap: () => _showAlternativeEmailInfoDialog(context),
                          child: const Padding(
  ...
  Future<void> _showAlternativeEmailInfoDialog(BuildContext context) async {
    final loc = AppLocalizations.of(context)!;
    await showDialog<void>(
      context: context,
      builder: (ctx) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            const SizedBox(width: 8),
            Text(
              loc.profile_alternative_email_info_title,
              style: const TextStyle(color: Colors.white),
            ),
          ],
        ),
        content: Text(
          loc.profile_alternative_email_info_body,
                            ...
                            if (!isGuest) ...[
                              ...
                              _buildProfileRow(
                                ...
                                value:
                                    ...
                                    ? Text(loc.profile_value_placeholder)
                                    : StreamBuilder<DocumentSnapshot>(
                                        stream: FirebaseFirestore.instance
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              loc.profile_birthday_readonly_hint,
