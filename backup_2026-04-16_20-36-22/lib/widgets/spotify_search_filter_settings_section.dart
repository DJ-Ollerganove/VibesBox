...
class _SpotifySearchFilterSettingsSectionState
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Suche-Filter gespeichert.'),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        const Text(
          'Ausgeschlossene Begriffe (Titel, Album, Interpret; nicht bei jeder Suche aus der Cloud geladen — 24h-Cache).',
        ...
        Text(
          'Max. Titel-Länge: ${_maxMinutes.round()} Min. (längere Einträge werden ausgeblendet)',
        ...
        FilledButton.icon(
          ...
          label: Text(_saving ? 'Speichern…' : 'In Cloud & lokal speichern'),
