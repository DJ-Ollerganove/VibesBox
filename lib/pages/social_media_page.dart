...
class _SocialMediaPageState extends State<SocialMediaPage> {
  ...
  String _vibesboxLabelForPlatform(String id, AppLocalizations l) {
    switch (id) {
      case 'instagram':
      ...
      default:
        return _getPlatformName(id, l);
    }
  }

  /// VibesBox-Kanäle: [admin_config/vibesbox_social] → optional [global_settings] → Offline-Fallback.
  Widget _buildGuestVibesboxSection(AppLocalizations l, bool isRtl) {
    return PwaWidgetCell(
      child: FutureBuilder<List<VibesboxSocialEntry>>(
        ...
        builder: (context, snapshot) {
          ...
          if (channels == null || channels.isEmpty) {
            return Padding(
              ...
              child: Text(
                l.vibesbox_social_media_follow_hint,
                textAlign: TextAlign.center,
          ...
          return Column(
            ...
            children: [
              Text(
                l.vibesbox_follow_updates_intro,
                style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                      color: Colors.white,
                      fontWeight: FontWeight.w600,
                      height: 1.35,
                      ...
                      return SizedBox(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            borderRadius: BorderRadius.circular(12),
                            child: Semantics(
                              label: _vibesboxLabelForPlatform(id, l),
                              button: true,
                              child: Container(
  ...
  /// Szenario C: Pro-DJ mit Links – 2-Spalten-Grid, orangefarbener Rahmen, nur Plattform-Icons.
  /// TikTok-Icon: weiß (SocialPlatformIcons) für schwarzen Hintergrund.
  Widget _buildScenarioC(AppLocalizations l) {
    final linksToShow = _linkOrder.isNotEmpty
        ? _linkOrder
              .where(
                (id) =>
  ...
  Widget build(BuildContext context) {
    ...
    // Gast (mit/ohne Party), unangemeldet: VibesBox / Session-DJ-Links. DJ ohne Party: Bearbeiten.
    final bool hasSession = svc.hasSession;
    final bool isLoggedInGuest =
        user != null && AppConfig.isGuestRole(UserService().currentUser.value);
    final bool showGuestView = hasSession || user == null || isLoggedInGuest;
    if (showGuestView) {
