...
class _BeendetePartysPageState extends State<BeendetePartysPage> {
  ...
  String _formatDateTimeCompact(DateTime date, BuildContext context) {
  ...
  Widget _buildBody(BuildContext context, AppLocalizations l) {
    ...
    final dropdownRow = Padding(
      ...
      child: Row(
        children: [
          const Text('Anzeige: ', style: TextStyle(fontSize: 14)),
          DropdownButton<int>(
            value: _limit,
          ...
          Expanded(
            child: Text(
              _totalCount >= 0
                  ? 'von insgesamt $_totalCount beendeten Partys'
                  : '${_endedParties.length} Partys angezeigt',
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(onPressed: _refresh, child: const Text('Erneut versuchen')),
                  ],
                ),
              ),
            ),
          ...
          child: RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final partyName = data['party_name'] ?? 'Unbenannt';
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(
                      '${_formatDateTimeCompact(start, context)} - ${_formatDateTimeCompact(end, context)}',
                    ),
                    trailing: IconButton(
                      ...
                      onPressed: () async {
                        ...
                        if (deleted == true && mounted) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Party erfolgreich gelöscht'),
                              backgroundColor: Colors.green,
                            ),
                          );
                        }
                      },
                      tooltip: 'Party unwiderruflich löschen',
                    ),
