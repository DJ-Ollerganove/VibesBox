...
class _AudioSettingsCardState extends State<AudioSettingsCard> {
  ...
  Future<void> _loadSettings() async {
    ...
    try {
      ...
      if (localStatusNotification != null) {
        _showStatusNotification = localStatusNotification;
      }
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    l.scan_interval_set(_formatInterval(seconds)) ?? 'Scan-Intervall auf ${_formatInterval(seconds)} gesetzt',
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    l.mic_sensitivity_set(sensitivity.toStringAsFixed(1)) ?? 'Mikrofon-Empfindlichkeit auf ${sensitivity.toStringAsFixed(1)} gesetzt',
                    style: const TextStyle(color: Colors.white),
                  ),
                ),
              ],
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    l.threshold_set((threshold * 100).toStringAsFixed(0)) ?? 'Schwellenwert auf ${(threshold * 100).toStringAsFixed(0)}% gesetzt',
                    style: const TextStyle(color: Colors.white),
                  ),
                ),
              ],
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveStatusNotification = _showStatusNotification;
    if (_isLoading) {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: Text(
                    '${l.scan_interval_label} ${_formatInterval(effectiveScanInterval)}',
                    style: TextStyle(
                      fontSize: 12,
            ...
            SliderTheme(
              ...
              child: Slider(
                ...
                max: 300,
                divisions: 27,
                label: _formatInterval(effectiveScanInterval),
            ...
            Row(
              ...
              children: [
                Switch(
                  value: effectiveStatusNotification,
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoBullet(
                    context,
                    l.info_scan_process,
                    l.info_scan_process_description,
                  ),
                  const SizedBox(height: 12),
                  _buildInfoBullet(
                    context,
                    l.info_scan_interval,
                    l.info_scan_interval_description,
                  ),
                  const SizedBox(height: 12),
                  _buildInfoBullet(
                    context,
                    l.info_mic_sensitivity,
                    l.info_mic_sensitivity_description,
                  ),
                  const SizedBox(height: 12),
                  _buildInfoBullet(
                    context,
                    l.info_recognition_threshold,
                    l.info_recognition_threshold_description,
                  ),
                  const SizedBox(height: 12),
                  _buildInfoBullet(
                    context,
                    l.info_smart_threshold,
                    l.info_smart_threshold_description,
                  ),
                  const SizedBox(height: 12),
                  _buildInfoBulletWithIcon(
                    context,
                    Icons.bolt,
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // Bullet-Point: Wird durch Directionality automatisch für RTL gespiegelt
            Text(
              '• ',
              style: TextStyle(
                fontWeight: FontWeight.bold,
            ...
            Expanded(
              child: Text(
                ...
                textAlign: TextAlign.start, // RTL support
              ),
            ),
          ],
        ),
        Padding(
          padding: const EdgeInsetsDirectional.only(start: 16.0, top: 4.0), // Use EdgeInsetsDirectional for RTL
          child: Text(
            description,
            style: TextStyle(
  ...
  /// Hilfsmethode für Info-Bullet-Points mit Icon
  Widget _buildInfoBulletWithIcon(BuildContext context, IconData icon, String title, String description) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // Icon: Wird durch Directionality automatisch für RTL gespiegelt
            Icon(
              icon,
              size: 16,
              color: Theme.of(context).colorScheme.primary,
        ...
        Padding(
          padding: const EdgeInsetsDirectional.only(start: 24.0, top: 4.0), // Use EdgeInsetsDirectional for RTL (24 wegen Icon + Abstand)
          child: Text(
            description,
            style: TextStyle(
              color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.7),
