...
class _ProfileImageSectionState extends State<ProfileImageSection> {
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(localizations.confirm_delete_logo, style: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
  ...
  Widget _buildLogoPreview(BuildContext context, {required bool isPro}) {
    final isFree = !isPro;
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<SessionProStatus?>(
      ...
      builder: (context, session, _) {
        final isPro = session?.isActive == true;
        return ValueListenableBuilder<UserModel?>(
          valueListenable: UserService().currentUser,
          builder: (context, _, __) {
            return _buildProfileImageLayout(context, isPro);
          },
        );
      },
    );
  ...
  Widget _buildProfileImageLayout(BuildContext context, bool isPro) {
    final localizations = AppLocalizations.of(context)!;
    final user = FirebaseAuth.instance.currentUser;
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: isHttpImageUrl(widget.djLogoUrl)
                        ? _buildLogoPreview(context, isPro: isPro)
