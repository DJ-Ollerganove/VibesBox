...
class _ShazamSettingsSectionState extends State<ShazamSettingsSection> {
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    l.shazam_mic_sensitivity_set(sensitivity.toStringAsFixed(1)),
  ...
  String _formatInterval(AppLocalizations l, int seconds) {
    if (seconds < 60) {
      return '$seconds ${l.interval_seconds_short}';
    } else {
      final minutes = seconds ~/ 60;
      final remainingSeconds = seconds % 60;
      if (remainingSeconds == 0) {
        return '$minutes ${l.interval_minutes_short}';
      } else {
        return '$minutes ${l.interval_minutes_short} $remainingSeconds ${l.interval_seconds_short}';
      }
    }
  }
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: Text(
                    '${l.scan_interval_label} ${_formatInterval(l, scanSliderValue)}',
            ...
            Slider(
                  ...
                  label: _formatInterval(l, scanSliderValue),
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    l.shazam_threshold_percent_set((threshold * 100).toStringAsFixed(0)),
                    style: const TextStyle(color: Colors.white),
                  ),
                ),
              ],
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(enabled
                ...
                : loc.shazam_autostart_disabled_snackbar),
            backgroundColor: Colors.green,
            duration: const Duration(seconds: 2),
          ),
        );
