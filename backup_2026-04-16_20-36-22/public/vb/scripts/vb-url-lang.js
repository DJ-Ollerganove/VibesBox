...
(function () {
  ...
  var DEFAULT_LANG = 'en';
  var ALLOWED = { de: 1, en: 1, fr: 1, ru: 1, zh: 1, es: 1, tr: 1, pt: 1, it: 1, uk: 1 };
  var STATIC_PWA_LANG_CODES = ['en', 'de', 'fr', 'ru', 'zh', 'es', 'tr', 'pt', 'it', 'uk'];
  ...
  var LANGUAGE_NAMES = { de: 'German', en: 'English', fr: 'French', ru: 'Russian', zh: 'Chinese', es: 'Spanish', tr: 'Turkish', pt: 'Portuguese', it: 'Italian', uk: 'Ukrainian' };
