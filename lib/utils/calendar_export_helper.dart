...
class CalendarExportHelper {
  ...
  static Future<void> exportParty(
    ...
    try {
      ...
      final partyName =
          partyData['party_name'] as String? ?? l.calendar_party_ics_untitled;
      ...
      final title = l.calendar_party_ics_title(partyName, timeAtLocation, timezoneDisplay);

      // Beschreibung zusammenstellen
      final descriptionParts = <String>[];
      
      descriptionParts.add(l.calendar_party_ics_body_time(timeAtLocation, timezoneDisplay));
      
      if (latitude != null && longitude != null && 
          latitude != 0.0 && longitude != 0.0) {
        final mapsUrl = 'https://www.google.com/maps/search/?api=1&query=$latitude,$longitude';
        descriptionParts.add(l.calendar_party_ics_body_maps(mapsUrl));
      }
