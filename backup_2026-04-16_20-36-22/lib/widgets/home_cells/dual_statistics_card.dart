...
class _CurrentPartyStatisticsCard extends StatelessWidget {
  ...
  Future<_PartyInfo> _loadPartyInfoById(String partyId) async {
    try {
  ...
  Future<_PartyInfo> _identifyParty(BuildContext context) async {
    ...
    return _PartyInfo(
      ...
      partyName: selectedPartyName ?? 'Unbenannte Party',
      isLive: isLive,
      startDate: startDate,
      endDate: endDate,
      isEmpty: false,
  ...
  Future<_PartyInfo> _getPartyInfoFuture(BuildContext context) async {
    ...
    if (preferredPartyId != null) {
      return _loadPartyInfoById(preferredPartyId!);
    }
  ...
  Widget _buildStatsCard(
    ...
    // Formatierung für Datum und Uhrzeit: TT.MM. HH:mm Uhr - TT.MM. HH:mm Uhr
    String dateTimeRange = '--:--';
    if (partyInfo.startDate != null && partyInfo.endDate != null) {
      dateTimeRange = '${_formatDateCompact(partyInfo.startDate!)} - ${_formatDateCompact(partyInfo.endDate!)}';
    } else if (partyInfo.startDate != null) {
      dateTimeRange = _formatDateCompact(partyInfo.startDate!);
    }
          ...
          PwaWidgetCell(
            child: Column(
              ...
              children: [
                ...
                Text(
                  partyInfo.partyName ?? 'Unbenannte Party',
                  style: const TextStyle(
                    fontSize: 22,
                    fontWeight: FontWeight.bold,
                ...
                // Zeitraum (kompakt): TT.MM. HH:mm Uhr - TT.MM. HH:mm Uhr (WEISS)
                ...
                if (stats.averageWaitTime != null) ...[
                  ...
                  Text(
                    'Durchschn. Wartezeit: ${stats.averageWaitTime!.toStringAsFixed(0)} Min.',
                    style: const TextStyle(
                      fontSize: 12,
                      color: Colors.grey,
                    ),
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        if (lastLogin != null) {
          lastLoginText = FormattingUtils.formatDateTimeForDisplay(lastLogin, context);
          lastLoginText = lastLoginText.replaceAll(' um ', ', ');
        }
        ...
        return PwaWidgetCell(
          child: Column(
            ...
            children: [
              ...
              // Gesamtzahl der Logins
              const SizedBox(height: 6),
              Text(
                'Gesamtzahl der Logins: $loginCount',
                style: const TextStyle(
                  fontSize: 12,
                  color: Colors.grey,
                ),
