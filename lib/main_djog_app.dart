...
class _DJOgAppState extends State<DJOgApp> {
  ...
  void dispose() {
    ...
    TextScaleService.instance.userFactor.removeListener(_onTextScaleChanged);
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        // Nach E-Mail-Login: gleiche Shell wie [home], Stack per pushNamedAndRemoveUntil leeren.
        '/main': (context) => const MainPage(),
        '/admin_dashboard': (context) => const MainPage(),
        '/dj_dashboard': (context) => const MainPage(),
        '/guest_dashboard': (context) => const MainPage(),
        '/location_dashboard': (context) => const MainPage(),
      },
    );
  }
}
