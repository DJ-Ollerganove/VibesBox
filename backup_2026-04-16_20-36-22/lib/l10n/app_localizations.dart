...
class AppLocalizations {
  ...
  /// Wenn `parties.total_guest_count` von der Gastliste abweicht (s. LiveGuestStatsView).
  String liveStatsPartyCounterMismatch(int partyCounter) =>
      translate('live_stats_party_counter_mismatch')
          .replaceAll('{count}', partyCounter.toString());
