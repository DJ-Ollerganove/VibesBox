    ...
    return cardBuilder(
      ...
      Column(
        ...
        children: [
          ...
          Text('Logins: $loginCount', style: Theme.of(context).textTheme.bodyMedium),
          Text('Musikwünsche: $totalWishes', style: Theme.of(context).textTheme.bodyMedium),
        ],
      ),
    );
  }
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Code: ${partyCode ?? ''}', style: Theme.of(context).textTheme.bodyMedium),
                  ],
                ),
              ),
...
class HomeThresholdCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return cardBuilder(
      ...
      Row(
        children: [
          const Expanded(child: Text('Duplikat-Limit (%)')),
          SizedBox(
            width: 70,
            child: TextField(
  ...
  Widget build(BuildContext context) {
    ...
    return cardBuilder(
      ...
      DropdownButtonFormField<String?>(
        ...
        decoration: const InputDecoration(labelText: 'Ansicht wechseln'),
        items: RoleDropdownHelper.getRoleDropdownItems(includeAdmin: isAdminUser),
        onChanged: onChanged,
      ),
    );
  }
