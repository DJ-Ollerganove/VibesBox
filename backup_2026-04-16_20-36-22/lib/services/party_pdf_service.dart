...
class PartyPdfService {
  ...
  static String formatDateTimeForPdf(DateTime date) {
            ...
            pw.Row(
              ...
              children: [
                ...
                pw.Column(
                  ...
                  mainAxisSize: pw.MainAxisSize.min,
                  children: [
                    pw.Text(startTimeLabel ?? 'Start:', style: startLabelStyle, textAlign: pw.TextAlign.right, textDirection: ltr),
                    pw.SizedBox(height: 2),
                ...
                pw.SizedBox(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text(djName ?? 'DJ', style: contactDjNameStyle, textDirection: ltr, maxLines: 2),
                    ],
                  ),
                ),
  ...
  static pw.Widget _buildPartyColumn({
    ...
    final useFullIntro = introBefore != null && djName != null && introAfter != null;
    return pw.Expanded(
      child: pw.Padding(
        ...
        child: _buildModularPartyContent(
          ...
          dateTimeText: dateText ?? formatDateTimeForPdf(startDate),
  ...
  static Future<void> generatePartyPdfDoubleA5(
    ...
    final cellContent = _buildModularPartyContent(
      ...
      partyCodeDisplay: partyCodeDisplay,
      contactBlockUnderQr: contactBlockUnderQr,
      dateTimeText: startTimeFormatted ?? formatDateTimeForPdf(startDate),
      startTimeLabel: startTimeLabel,
      scanLine1: scanLine1,
      scanLine2: scanLine2,
      qrSize: 200,
      ...
      maxWidth: 350,
      introFontSize: 12,
      introBefore: introBefore ?? 'Scanne den Code und sende deine Musikwünsche direkt an ',
      djName: djName ?? 'DJ',
      introAfter: introAfter ?? '!',
      venueLine: venueLine,
      venueLabel: venueLabel,
